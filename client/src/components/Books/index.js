...
import { getBookWidthReviewer, clearBookWidthReviewer } from '../../actions'
import { connect } from 'react-redux';

class BookView extends Component {
    componentWillMount() {
        this.props.dispatch(getBookWidthReviewer(this.props.match.params.id))
    }

    componentWillUnmount() {
        this.props.dispatch(clearBookWidthReviewer())
    }
